...
const totalPopulation = populations.reduce((acc, i) => acc + i)
...
const myStrongest = monstersInYourPocket.filter((creater) => creater.CP > 200)
...
const totals = orders.map((st) => st.price + (st.price * st.tax) )
// console.log(totals)
